    ...
    <div className="flex flex-col h-full print:block">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Stats + Due Summary */}
          <div className="lg:col-span-2 space-y-4 content-start">
            {/* Purchase count + date range */}
              ...
              <CardContent className="px-5 pb-5">
                <div className="grid grid-cols-3 divide-x divide-border">
                  ...
                  <div className="pr-4 space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">billed (excl. cancelled)</p>
                  </div>
                  ...
                  <div className="pl-4 space-y-1">
                    ...
                    {loadingStats ? (
                      ...
                      <p className={`text-xl font-bold tracking-tight ${
                        (stats?.pendingAmount ?? 0) > 0 ? "text-red-600" : "text-muted-foreground"
                      }`}>
                        {formatCurrency(stats?.pendingAmount ?? 0)}
                      </p>
                    )}
                    <p className="text-xs text-muted-foreground">
                      {(stats?.pendingAmount ?? 0) > 0 ? "balance due" : "all clear"}
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        {/* ── Tabs ─────────────────────────────────────────── */}
        <Tabs defaultValue="purchases" className="print:hidden">
